! function(e, t) {
    e("data/saraGame", function(e, t, n) {
        window._random = Math.floor(Math.random() * (window._count - 0) + 1);
        window.isOver = false;
        n.exports = [{
            type: "sara",
            ka: [{
                ...
                id: "1",
                pic: [{
                    img: "assets/img/game/" + (window._random) + "/1.jpg",
                    row: 3,
                    column: 3
                }]
            }, {
                ...
                pic: [{
                    ...
                    img: "assets/img/game/" + (window._random) + "/2.jpg",
                    row: 3,
                    type: 2,
                    second: 30,
                    column: 3
                }, {
                    img: "assets/img/game/" + (window._random) + "/3.jpg",
                    row: 3,
                    type: 2,
                    second: 30,
                    column: 3
                }, {
                    img: "assets/img/game/" + (window._random) + "/4.jpg",
                    row: 4,
                    type: 2,
                    second: 60,
                    column: 4
                }, {
                    img: "assets/img/game/" + (window._random ) + "/5.jpg",
                    row: 4,
                    type: 2,
                    second: 60,
                    column: 4
    ...
    }), e("page/sara/templates", function(e, t, n) {
        var a = e("underscore"),
            r = e("af");
        n.exports = {
    ...
    }), e("page/sara/phoneReady", function(e, n, a) {
        function r() {
    ...
    }), e("page/sara/userData", function(e, t, n) {
        var a = e("af"),
            r = {},
            i = {};
        r.get = function(e, t) {
    ...
    }), e("page/sara/game/gameCenter", function(e, t, n) {
        function a(e, t, n, a) {
            for (var r = [], i = 0; e > i; i++)
                for (var o = 0; t > o; o++) r.push({
                    sort: i * t + o + 1,
                    x: -o * n,
                    y: -i * a,
                    w: n,
        ...
        n.exports = function(e) {
            ...
            var l = o(),
                ...
                d = c.getTemplate("saraLayoutTemplate");
    ...
    }), e("page/sara/game/stopwatch", function(e, t, n) {
    ...
    }), e("page/sara/game/sara", function(e, n, a) {
        var r = e("af"),
            i = e("underscore"),
            o = e("module/model"),
            s = e("page/sara/templates"),
            c = e("page/sara/game/gameCenter"),
            u = (e("page/sara/game/timer"), e("module/utils")),
            g = e("page/sara/game/stopwatch"),
            l = function() {
                var e = this;
                e.config = {
                    img: "",
        ...
        i.extend(l.prototype, o()), l.prototype.init = function(e) {
            var n = this;
            n.dom = r(e);
            var a = s.getTemplate("saraTemplate")();
    ...
    }), e("page/sara/p/picture", function(e, t, n) {
        function a(e) {
            for (var t = 0; t < c.length; t++)
                if (c[0].type == e) return c[0]
        }
        ...
        function r(e) {
            ...
            var r = n.pic[p.currentGame.pic];

            p.dom.find(".kapics").html("第(" + (p.currentGame.pic + 1) + "/" + n.pic.length + ")关，本关限时 " + r.second + " 秒"), u.set(f, p.currentGame), p.saraGame.setConfig(r)

        }
        var i = e("af"),
            o = e("page/sara/templates"),
            s = e("page/sara/game/sara"),
            c = e("data/saraGame"),
            u = e("page/sara/userData"),
            g = e("module/utils"),
            l = e("ui/baseLayer"),
            m = e("ui/showDialog"),
            p = {};
        p.init = function(e) {
            var t = o.getTemplate("saraTemplate")();
            e.html(t), p.saraGame = s, p.saraGame.init(e), p.dom = e, p.saraGame.on("picOver", function(e) {

                window.score = p.currentGame.pic + 1;
                localStorage.setItem("score", score);
                dp_submitScore(score);
                var str = "恭喜您挑战成功，共闯过了<em>" + (p.currentGame.pic + 1) + "</em>关";
                if (!p.hasNextPic()) {
                    str = "恭喜您全部通关！共闯过了<em>" + (p.currentGame.pic + 1) + "</em>关，分享到朋友圈炫耀一下吧!";
                }
                showGameResult(str, true, p.hasNextPic());
            }), p.saraGame.on("timeout", function() {
                showGameResult("挑战失败，共闯过了<em>" + (p.currentGame.pic) + "</em>关", false, p.hasNextPic());
            })

            $('#againgame').click(function() {
                window.isDo = true;
                DCAgent.onEvent("再来一次", 1, {
                    userID: "null"
                });
                window.location.href = window.location.href+"?v=again";
            });
            $('#restartgame').click(function() {
                window.isDo = true;
                DCAgent.onEvent("重新开始", 1, {
                    userID: "null"
                });
                p.currentGame.pic--;
                p.playNextPic();
        ...
        p.showNextKa = function() {
            ...
            if (!window.costScuessTime) {
                costScuessTime = 0;
            }

            costScuessTime = Math.round(parseFloat(costScuessTime) + (parseFloat(p.saraGame.config.second) - parseFloat($(".counter").html()))*100)/100;
    ...
    }), e("page/sara/pageController", function(e, t, n) {
        function a(e, t, n) {
            var a = "page-anmi",
                r = "page-anmi",
                i = "",
        ...
        var i = e("module/model"),
            ...
            s = e("page/sara/templates"),
            c = e("af"),
            u = e("page/sara/phoneReady"),
            g = e("page/sara/userData"),
            l = i(),
            m = {
                pageIndex: ["picture"],
                pages: {},
    ...
    }), e("page/sara/index", function(e) {
        var t = e("data/saraGame"),
            n = e("page/sara/pageController");
        n.init(t)
    })
...
if ($("#pageWrapper").css("display") == "block") {
    $("#pageWrapper").hide();
}
// isHideIndex=location.href.indexOf("v=again")!=-1;
// if(isHideIndex){
//     $("#index").hide();
//     $("#pageWrapper").show();
// }

...
//                }
    ...
    var Upload = {
        ...
        config: function (sel) {
            ...
            // var url="http://api-test.dymfilm.com/image/upload";"http://localhost:8080/image/upload"

            $("form", $(sel, me.dialog)).attr("action", "http://api-test.dymfilm.com/image/upload");
            // $(".edui-btn-primary").on('click',function(){
            //     me.postUpload();
            // });
        ...
        postUpload:function(){
                 $.ajax({
                        type: "POST",
                        url: "http://127.0.0.1/editor/umeditor_ing/php/imageUp.php",
                        dataType: 'JSONP',
                        //jsonp的值自定义,如果使用jsoncallback,那么服务器端,要返回一个jsoncallback的值对应的对象. 
                        // jsonp: 'jsoncallback',
                        success: function(data) {
                            console.log('upload-fcc');
                            debugger
                        },
                        error: function(data) {}
                 });
        ...
        //更新input
        updateInput: function ( inputField ) {debugger
